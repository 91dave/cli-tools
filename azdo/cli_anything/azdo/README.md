...
2. **Logged in**: `az login --tenant your-tenant.onmicrosoft.com`
...
```bash
az account get-access-token --resource 499b84ac-1321-427f-aa17-267ca6975798 --tenant your-tenant.onmicrosoft.com
```
